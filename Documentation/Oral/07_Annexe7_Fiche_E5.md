...
- Docker + Docker Compose — orchestration 9 services (OpenLDAP, GLPI, Nextcloud, WireGuard, ClamAV, phpLDAPadmin, Portainer, + 2 bases de données MariaDB)
...
- SRV_MEDIASCHOOL_MAIN (192.168.50.10 / 192.168.56.10) : serveur principal actif — OpenLDAP, GLPI, Nextcloud, WireGuard, ClamAV, phpLDAPadmin, Portainer, BorgBackup client, Keepalived MASTER
...
- Script health check toutes les 5s : vérifie Nextcloud, GLPI et OpenLDAP — déclenche failover si KO
...
- Docker + Docker Compose : 9 services (OpenLDAP, GLPI, Nextcloud, WireGuard, ClamAV, phpLDAPadmin, Portainer, + 2 bases MariaDB)
